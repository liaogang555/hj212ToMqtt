...
final class MqttChannelHandler extends SimpleChannelInboundHandler<MqttMessage> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, MqttMessage msg) throws Exception {
        log.info("message receive from host {}, msg {}.",ctx.channel().remoteAddress(),msg);
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        log.info("mqtt channel {} active, going to send mqtt connect message.",ctx.channel().remoteAddress());
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        log.info("@@@@@@@@@@@@@@ channelInactive, remote address {} @@@@@@@@@@@@@@@@@@",ctx.channel().remoteAddress());
    }

    @Override
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        super.exceptionCaught(ctx, cause);
        log.error("channel {} occur error, message {}, please check.",ctx.channel().remoteAddress(),cause);
    }
